...
---2nd query
  COUNT(CASE WHEN Class = 'Business' THEN 1 END) AS BusinessClass_Passengers_Count,  
...
---5th query
  COUNT(CASE WHEN age > 16 AND Class = 'Business' THEN 1 END) AS AdultBusinessClass_Passengers_Count
FROM airline;
